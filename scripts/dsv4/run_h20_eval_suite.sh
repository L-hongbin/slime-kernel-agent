...
OUTPUT_ROOT=${H20_EVAL_SUITE_ROOT:-${DISK_ROOT}/csl_v4_kernelbench_3turn_20260801}
ADAPTER_ROOT=${H20_EVAL_ADAPTER_ROOT:-${DISK_ROOT}/csl_v4r21_fp4_pp1cp2_12k_dppo_predictive_resume40_20260722/eval_adapters}
