...
MAX_CONTEXT_LEN="${MAX_CONTEXT_LEN:-80000}"
MAX_RESPONSE_LEN="${MAX_RESPONSE_LEN:-60000}"
...
EXP_NAME="Eval.${MODEL_TAG}.reson${REASONING_EFFORT^}.ctx${MAX_CONTEXT_LEN}.resp${MAX_RESPONSE_LEN}.T${TEMPERATURE}.P${TOP_P}"
