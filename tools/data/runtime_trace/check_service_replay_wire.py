...
from tools.data.runtime_trace.service_replay import _prepare_precompiled_artifact, report
...
def _prepare(root, *, max_summary_nodes, include_collector=True, binding_case="ok"):
...
def _run(fixture, *, max_summary_nodes, include_collector=True, binding_case="ok"):
...
def main():
    ...
    print("service replay wire: complete, truncated, missing-identity, and binding-negative paths passed")
