...
def policy_loss_function(
    ...
    if use_dppo_binary:
        ...
        policy_loss_output = {
            key: torch.cat(
                [
                    slice_log_prob_with_cp(item[key], total_length, response_length)
                    for item, total_length, response_length in zip(
                        per_sample_outputs,
                        total_lengths,
                        response_lengths,
                        strict=False,
    ...
    elif policy_loss_mode == "cispo" or args.advantage_estimator == "cispo":
